...
export const TRANSLATIONS: Record<Language, Translations> = {
  ...
  tuv: {
    ...
    about: {
      ...
      body1: 'Чаваг Медиа дээрге Тываның кыс чонунуң болгаш өске дарладып турар кижилерниң эргелериниң болгаш хостуг чоруунуң дугайында айтырыгларны көдүрүп турар бөлүк. Кыстарга фем-бөлүк кылыр санал шагда-ла турган, ынчалза-даа март 2024 чылдың март 8-те бис Чавага Медиа деп медианы ажыткан бис.',
